...
from models.student_model import StudentNet  # Adjust import if needed
...
def test_student_model_on_video(video_path, weight_path):
    ...
    os.makedirs("student_output/output_student", exist_ok=True)
    out_path = "student_output/output_student/output_student_video_side_by_side.mp4"
...
if __name__ == "__main__":
    test_student_model_on_video(
        video_path="student_output/input_student/sample_degraded.mp4",
