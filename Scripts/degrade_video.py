...
if __name__ == "__main__":
    degrade_video(
        input_video_path="Output/student_output/target_student/sample_video.mp4",     # Replace with your high-quality video
        output_video_path="Output/student_output/input_student/sample_degraded.mp4"  # Output degraded video
    )
