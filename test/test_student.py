...
# === Fix for 'ModuleNotFoundError: No module named models' ===
...
def test_student_model(blur_path, weight_path):
    ...
    # Save output
    output_dir = os.path.join("Output", "student_output", "output_student")
...
if __name__ == "__main__":
    test_student_model(
        os.path.join("Output", "student_output", "input_student", "img26.jpg"),
